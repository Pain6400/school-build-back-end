...
import { createClass, createClassRoom, getClassByScool, getClassByStudent, getClassRooms } from "../controllers/class.controller.js";
...
router.get("/getClassByStudent/:student_id", requireToken, checkRoleAuth([ROLES_SETTING.SUPERADMIN, ROLES_SETTING.STUDENT]), getClassByStudent);
